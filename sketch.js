...
function draw(){
  ...
  if(ball.isTouching(brick1)){
    ball.bounceOff(brick1);add+=1;score+=3;lives+=1;brick1.destroy();hit3.play()
  }  
  ...
  if(ball.isTouching(brick13)){
    ball.bounceOff(brick13);add+=1;score+=3;lives+=1;brick13.destroy();hit3.play()
  }  
  ...
  if(ball.isTouching(brick18)){
    ball.bounceOff(brick18);add+=1;score+=1;lives+=1;brick18.destroy();hit3.play()
  }  
